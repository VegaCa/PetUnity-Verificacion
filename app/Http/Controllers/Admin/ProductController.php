...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (auth()->user()->utype === 'ADMIN') {
            return redirect()->route('admin.products.index')->with('msgSuccess', 'Anuncio registrado exitosamente');
        } else {
            // Si no, solo muestra los productos del usuario
            return redirect()->route('user.products.index')->with('msgSuccess', 'Anuncio registrado exitosamente');
        }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        if (auth()->user()->utype === 'ADMIN') {
            return redirect()->route('admin.products.index')->with('msgSuccess', 'Anuncio actualizado exitosamente');
        } else {
            // Si no, solo muestra los productos del usuario
            return redirect()->route('user.products.index')->with('msgSuccess', 'Anuncio actualizado exitosamente');
        }
    }
